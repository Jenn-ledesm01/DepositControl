...
{
    public partial class StateDeliveryNote : IEntityDao, IName, ICode, IOrder
    {
        ...
        private static StateDeliveryNoteDao _dao;
        public static StateDeliveryNoteDao Dao
            => _dao ?? (_dao = new StateDeliveryNoteDao());
    }
}

namespace DepositControl.Dao
{
    public partial class StateDeliveryNoteDao : DaoDb<StateDeliveryNote>
    {
