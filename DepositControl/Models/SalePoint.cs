...
{
	public partial class SalePoint : IEntityDao, IName, ICode, IOrder
    {
        ...
        private static SalePointDao _dao;
        public static SalePointDao Dao
            => _dao ?? (_dao = new SalePointDao());
...
{
    public partial class SalePointDao : DaoDb<SalePoint>
    {
